...
def stable_dqn(agent_params):
    ...
    checkpoint_callback = CheckpointCallback(save_freq=8640, save_path=save_path,
    ...
    model.learn(total_timesteps=86400, log_interval=4, callback=checkpoint_callback)
